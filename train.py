...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_adv', type=str2bool, default=True, help='use adv loss.')
    parser.add_argument('--use_cons', type=str2bool, default=True, help='use cons loss.')
    parser.add_argument('--use_ca', type=str2bool, default=True, help='use color alignment.')
